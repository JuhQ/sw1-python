...
- Osatehtävien ohjeiden mukainen palautus ajallaan: 0-5 p (piste/tehtävä).
  ...
  - Funktiot ja listat
  - Sovellus on jaettu tarkoituksenmukaisiin tiedostoihin ja paketteihin
  - Tiedostoon kirjoittamisen (ja lukemisen) hyödyntäminen
- Pelin voi pelata läpi ja vähintään 3 erilaista reittiä: 1 p.
- Asiallinen dokumentaatio ja kommentit 1 p.
- Funktioiden käyttö
  - vähintään 5 kpl: 1 p.
